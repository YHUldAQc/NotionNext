...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hey there., Welcome.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kebao', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录点什么', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://example.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '信安, 网络安全, OSCP', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备11000002000018', // 备案号 闽ICP备XXXXXXX
